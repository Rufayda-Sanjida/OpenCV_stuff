...
def main():
    ...
    return middle_average_depth_100
    status = camera1.stop()
...
def doingTwo():
    ...
    user_input = input("PUT BACKGROUND IN FRAME! Ready? Y/N")

    while user_input != "Y":
        user_input = input("PUT BACKGROUND IN FRAME! Ready? Y/N")

    background_average = main()
    print("Done getting background!")
    
    user_input = input("PUT OBJECT IN FRAME! Ready? Y/N")

    while user_input != "Y":
        user_input = input("PUT OBJECT IN FRAME! Ready? Y/N")

    object_average = main()
    print("Done getting Object!")

    
    thickness_mm = background_average - object_average
    thickness_cm = (background_average - object_average) // 10

    print(f"The thickness of object is: {thickness_mm} mm or {thickness_cm} cm")
