...
def animate():
    ...
    return pygame.surfarray.make_surface(normalize(image, frameDataDetails.width, frameDataDetails.height)), middle_depth_average, normalize(image) #Converts NumPy image into a format Pygame can show
...
def main():
    ...
    while x < 100 and not done:
        ...
        # Overlay: rectangle on center region
        rect_size = 20
